...
public:
    ...
    void pruneHelper(const int tol, Node* u);
    ...
    */
    int PShelper(const int tol, Node* u) const;
...
private:
    ...
    void copyOperator(Node* replace, Node* current);

    Node* copyConstructor(Node* replace);
